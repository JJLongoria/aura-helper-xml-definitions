import { StringXMLField, BooleanXMLField, EnumXMLField, ArrayXMLField, XMLDependencyField, DataValues, MetadataTypes } from '@aurahelper/core';
import { filterItem } from './types/filterItem';

export const AssigmentRules = {
